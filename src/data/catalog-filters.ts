...
const rawCatalogSubcategories: CatalogSubcategory[] = [
  ...
  },
  {
    ...
    productIds: [
      ...
      "tubo-y-para-estetoscopio",
      "membrana-para-estetoscopio-premium",
      "kit-reposicao-estetoscopio-rappaport",
    ],
  ...
  },
  {
    ...
    description: "Martelos, lanternas e acessórios para avaliação clínica",
    productIds: ["martelo-buck-neurologico", "lanterna-clinica"],
  ...
  },
  {
    ...
    productIds: ["termometro-digital", "termometro-infravermelho-easy-sensor"],
  ...
  },
  {
    ...
    productIds: ["glicometro", "tiras-reagentes-para-glicose", "lanceta-caneta-lancetadora", "caneta-lancetadora"],
  ...
  },
  {
    ...
    productIds: [
      ...
      "joelheira-articulada-ajustavel",
      "imobilizador-de-joelho",
      "protetor-para-punho",
      "munhequeira-ajustavel",
      "ortese-comfort-air-com-polegar",
      "ortese-comfort-air-sem-polegar",
      "ortese-comfort-air-longa-com-polegar",
      "ortese-comfort-air-longa-sem-polegar",
      "cinta-hernia-inguinal-simples",
      "cinta-hernia-inguinal-dupla",
      "cotoveleira",
      "tennis-elbow-ajustavel",
      "tipoias-e-suportes-de-ombro",
      "tipoia-estofada-imobilizadora-velpeau",
    ],
  ...
  },
  {
    ...
    productIds: [
      ...
      "faixa-elastica-4-paineis",
      "cinta-lombar",
      "cinta-modeladora-kestal-pink",
      "colete-putti-basic-baixo",
      "colete-putti-alto",
      "colete-putti-max-baixo",
      "colete-putti-max-alto",
  ...
  },
  {
    ...
    productIds: [
      ...
      "bolas-algodao-100g",
      "caixa-descarpack-7-litros-perfuro-cortante",
      "caixa-descarpack-3-litros-perfuro-cortante",
    ],
  ...
  },
  {
    ...
    productIds: [
      "gaze",
      "gaze-karina-500-unidades",
      "ataduras",
      "esparadrapo",
      "micropore",
      "curativo-hidrocoloide",
      "curativo-esteril-petrolatum",
    ],
    featuredProductId: "curativo-esteril-petrolatum",
  },
  {
    id: "injecao-e-acesso",
    categoryId: "cuidados-medico-hospitalares",
  ...
  },
  {
    ...
    description: "Sondas, coletores, comadres e dispositivos externos",
    productIds: [
      "sonda-uretral-n08",
