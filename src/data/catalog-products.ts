...
const rawCatalogProducts: CatalogProduct[] = [
  ...
  },
  {
    ...
    description: "O propé descartável é uma sapatilha de uso único com borda elástica para ajuste sobre o calçado. A apresentação fotografada é branca, em pacote com 100 unidades. Confirme a gramatura e a quantidade disponíveis.",
    images: [{ src: "/Produtos/prope-descartavel.webp", alt: "Pacote com 100 propés descartáveis brancos em TNT" }],
    highlights: ["TNT branco", "Borda elástica", "Uso único"], badges: ["Descartável", "Proteção"],
    consultation: ["Quantidade por pacote", "Gramatura", "Disponibilidade"], keywords: ["prope", "sapatilha descartavel", "tnt", "cobre sapato"],
  },
  {
    id: "gaze",
    categoryId: "cuidados-medico-hospitalares",
  ...
  {
    id: "comadre-plastica", categoryId: "cuidados-medico-hospitalares", brandIds: [], name: "Comadre Plástica",
    summary: "Comadre plástica branca reutilizável para uso no leito, com cabo para manuseio.",
    description: "A comadre plástica é um recipiente anatômico em plástico rígido, usado para as eliminações de pacientes acamados ou com mobilidade reduzida. Possui formato de pá com bordas arredondadas, que facilitam o posicionamento sob o paciente, e cabo lateral para apoio no manuseio e no descarte. É reutilizável: pode ser lavada e desinfetada entre os usos. Confirme a capacidade e a disponibilidade.",
    images: [{ src: "/Produtos/comadre.webp", alt: "Comadre plástica branca com cabo lateral" }],
    highlights: ["Formato anatômico em pá", "Bordas arredondadas", "Cabo para manuseio", "Lavável e reutilizável"], badges: ["Cuidados", "Reutilizável"], consultation: ["Capacidade", "Modelo", "Disponibilidade"], keywords: ["comadre", "aparadeira", "acamado", "leito", "higiene", "plastica"],
  },
  {
    id: "papagaio-plastico", categoryId: "cuidados-medico-hospitalares", brandIds: [], name: "Papagaio Plástico com Tampa",
    summary: "Urinol masculino em plástico translúcido, com alça e tampa.",
    description: "O papagaio (urinol masculino) é um coletor de urina em plástico translúcido, indicado para pacientes acamados ou com mobilidade reduzida, no hospital ou em casa. Tem gargalo anatômico, alça integrada para segurar e transportar e tampa rosqueável que reduz odores e derramamentos. O corpo translúcido permite visualizar o volume coletado. É reutilizável, podendo ser lavado e desinfetado. Confirme a capacidade e a disponibilidade.",
    images: [{ src: "/Produtos/papagaio-plastico.webp", alt: "Papagaio urinol masculino de plástico translúcido com tampa azul" }],
    highlights: ["Tampa rosqueável", "Alça integrada", "Corpo translúcido", "Lavável e reutilizável"], badges: ["Cuidados", "Reutilizável"], consultation: ["Capacidade", "Modelo", "Disponibilidade"], keywords: ["papagaio", "urinol", "coletor de urina", "masculino", "acamado", "com tampa"],
  },
  {
  ...
  },
  {
    ...
    images: [{ src: "/Produtos/mascara-tripla-descartavel-50-medix.webp", alt: "Caixa Medix com 50 máscaras descartáveis brancas de tripla camada" }],
  ...
  },
  {
    ...
    images: [{ src: "/Produtos/touca-descartavel-100.webp", alt: "Pacote de toucas descartáveis brancas sanfonadas" }],
